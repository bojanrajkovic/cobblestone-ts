/**
 * Cobblestone-128: the c2sp.org/chunked-encryption high-level API over
 * AEAD_AES_128_GCM. Keys are 16 bytes and MUST be uniformly random.
 */

import { AES_128_GCM } from "./internal/derive.js";
import {
...
const c: CobblestoneInstance = makeCobblestone(AES_128_GCM);
